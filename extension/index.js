    ...
    async function sendMessage() {
        ...
        try{
            ...
            const response = await fetch("http://spark-backend-iueorz-8a8891-72-62-125-194.traefik.me/chat", {
                method: 'POST',
                headers: {
    ...
    async function clearMessages() {
        ...
        await fetch("http://spark-backend-iueorz-8a8891-72-62-125-194.traefik.me/clear", {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            }
